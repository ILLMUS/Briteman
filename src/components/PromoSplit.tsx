    ...
    <section className="bg-secondary py-10">
      <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-px bg-border border border-border">
        ...
        <div className="bg-brand-red text-white p-8 md:p-12 flex flex-col justify-center min-h-[220px] relative overflow-hidden">
          ...
          <div className="relative">
            <div className="text-xs font-bold uppercase tracking-[0.25em] text-white/80 mb-3">Fast Ordering</div>
            <h3 className="font-display text-2xl md:text-3xl font-bold mb-3 leading-tight">
              Need it today? <br /> Order on WhatsApp.
            </h3>
            <a href="/contact" className="inline-block mt-2 bg-white text-brand-red px-6 py-3 text-xs font-bold uppercase tracking-wide hover:bg-brand-blue hover:text-white transition-colors">
              Chat With Us
            </a>
          </div>
        </div>
